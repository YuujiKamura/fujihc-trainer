...
substrate: commit 83c34b1 + 既存 viewer-map3d.js (1500 行) + 32 test files
...
1. viewer-map3d.js:748 の module top-level dispatch を ε-2 で同時 guard しないと `?map=1` 直叩き bypass が物理的に消えない
