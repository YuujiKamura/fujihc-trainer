...
// (a) viewer-map3d.js は navigator.bluetooth を直叩きしない (= ble_client に閉じる)
...
const VIEWER = resolve(__dirname, '..', 'viewer-map3d.js');
...
describe('brief 32: BLE / WS / viewer の責務分離 (物理 grep gate)', () => {
  ...
  it('viewer-map3d.js に navigator.bluetooth 直叩きゼロ (= ble_client.js に閉じる)', () => {
