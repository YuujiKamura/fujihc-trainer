...
describe('b125b: ride 時計 6 module-global が viewer-maplibre.js から撤去されている', () => {
  it.each([
    'rideStartedAt',
    'rideStartedIso',
    'lastRideDurationS',
    ...
    'lastTrkptT',
    'lastAutosaveT',
  ])('module-global %s が viewer-maplibre.js に存在しない (= 関数引数 / object key を除く宣言・代入の grep)', (name) => {
  ...
  it('viewer-maplibre.js が ride_clock.js を import している', () => {
